...
<div class="navigation-container">
  ...
  <nav class="bottom-nav">
      ...
      <select style="text-transform: uppercase;text-align:center;background-color: #15449a; color: #fff; font-size:14px;box-shadow: 0 0 20px 2px rgba(242, 242, 242);font-weight: bold; width:250px;margin-left:0px;margin-top:0px;" name="courseID" class="select">
    ...
    <select style="text-transform: uppercase;text-align:center;background-color: #15449a; color: #fff; font-size:14px;box-shadow: 0 0 20px 2px rgba(242, 242, 242);font-weight: bold; width:250px;margin-left:0px;margin-top:0px;" name="sectionNum" class="select">
    ...
    <input type="text" style="background-color:#15449a;height:36px;cursor: pointer;border-radius: 5px;
           ...
           outline:none;text-align:center;color:white;width:250px;margin-top:0px;box-shadow: 0 0 20px 2px rgba(242, 242, 242);" 
           placeholder="Student ID" name="studentID"/>

    <select style="text-transform: uppercase;text-align:center;background-color: #15449a; color: #fff; font-size:14px;box-shadow: 0 0 20px 2px rgba(242, 242, 242);font-weight: bold; width:250px;margin-left:0px;margin-top:0px;" name="semester" class="select">
     ...
     <select style="text-transform: uppercase;text-align:center;background-color: #15449a; color: #fff; font-size:14px;box-shadow: 0 0 20px 2px rgba(242, 242, 242);font-weight: bold; width:250px;margin-left:0px;margin-top:0px;" name="year" class="select">
    ...
    <input type="submit" style="background:#00BFFF;border-radius:10px;border:none;outline:none;color:#fff;font-size:14px;letter-spacing:2px;
              text-transform:uppercase;cursor:pointer;font-weight:bold;margin-top:100px;margin-bottom:50px;margin-left:48%;height: 36px;width: 100px;" name="submit" value="Submit" class="submitButton">
